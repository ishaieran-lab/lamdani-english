...
function _showConfirm(opts) {
    ...
    var imgOverlay = opts.img
        ? '<div style="position:relative;display:block;">' +
              ...
              '<button id="ccCancel" style="position:absolute;left:18%;bottom:11%;width:26%;border:none;background:transparent;cursor:pointer;padding:0;">' +
                  '<img src="images/ui/כפתור ביטול.png" style="width:100%;display:block;">' +
              '</button>' +
              '<button id="ccOk" style="position:absolute;right:18%;bottom:11%;width:26%;border:none;background:transparent;cursor:pointer;padding:0;">' +
